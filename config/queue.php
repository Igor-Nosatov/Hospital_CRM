    ...
    */
    ...
    'connections' => [
        ...
        'kafka' => [
            ...
            'group_id' => env('KAFKA_CONSUMER_GROUP_ID', 'default'),
            'auto_offset_reset' => env('KAFKA_AUTO_OFFSET_RESET', 'latest'),
            'offset_store_method' => env('KAFKA_OFFSET_STORE_METHOD', 'file'),
            'offset_store_path' => env('KAFKA_OFFSET_STORE_PATH', storage_path('logs/kafka_offset')),
        ],
    ],
